...
class AtmsControllerTest < ActionController::TestCase
  ...
  test "should create atm" do
    assert_difference('Atm.count') do
      post :create, atm: { address: @atm.address, bank: @atm.bank, latitude: @atm.latitude, longitude: @atm.longitude }
    end
  ...
  test "should update atm" do
    patch :update, id: @atm, atm: { address: @atm.address, bank: @atm.bank, latitude: @atm.latitude, longitude: @atm.longitude }
    assert_redirected_to atm_path(assigns(:atm))
  end
